...
function creatPopUp(name, description, img, techs, live = "SeeLive", source = "SeeSource") {
    ...
    image.setAttribute('style', 'justify-self: center max-width: 700px; width: 100%');
...
for (let i = 0; i < projectList.length; i++) {
    ...
    <button 
        class="card-btn"
        type="button">${projectList[i].button}</button>
    </div> `
}
